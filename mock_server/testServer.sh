...
curl -H "Content-Type:application/json" -X POST "localhost:55004/t4t/0.1/disruptions/route/" -d "{JSON LIST of points}"

curl -H "Content-Type:application/json" -X POST "localhost:55004/t4t/0.1/report" -d "{EVENT REPORT}"
