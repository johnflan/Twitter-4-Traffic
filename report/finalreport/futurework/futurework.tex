...
Empirically, the behaviour of users of social media in a specific timeframe of each day of
...
Traffic disruptions can be detected using that theory. What should be detected
is if there is extra usage of the social media and the users talk about
...
there is no need to inform a driver about that.
...
were created for latitude and longitude from which the social data where
coming. They represent the "normal" behaviour of the social media users. For all clustering
